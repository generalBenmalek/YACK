...
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:io';
import 'package:yack/db/isar_adapter.dart';
import 'package:cloudinary_public/cloudinary_public.dart';
...
Future<Map<String, dynamic>> closeContract(String id, String userId) async {
  try {
    ...
    DatabaseReference closeRef = FirebaseDatabase.instance.ref("contracts/$id/close");
    ...
    if (data == null) {
      ...
      DatabaseReference completedRef = FirebaseDatabase.instance.ref("completedContracts/$id");
...
Future<void> syncCompletedContractsStatus() async {
  try {
    ...
    for (var contract in contracts) {
      ...
      final completedRef = FirebaseDatabase.instance.ref('completedContracts/$id');
...
/// Accept Contract - Fixed to include userId (Chadli)
Future<Map<String, dynamic>> acceptContract(String contractId, String userId, Map<String, dynamic> contractDetails, String inviterId) async {
  try {
    DatabaseReference ref = FirebaseDatabase.instance.ref("invitation/$contractId");
